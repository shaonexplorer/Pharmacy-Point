...
import { Loader2, AlertCircle, PiggyBank, ArrowLeft } from 'lucide-react';
import Link from 'next/link';

/* ──────────────────────────────────────────────────────────────────────────── *
 * Clinical Precision — Edit Expense Page
 *
 * Layout follows the same pattern as EditCompanyPage:
      ...
      <div className="w-full space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div className="prescription-border-l pl-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-headline-lg text-foreground">Edit Expense</h1>
                <p className="mt-1 text-body-md text-on-surface-variant">
                  Update expense information for #{expense.id.slice(0, 8)}.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="rounded-xl border border-border bg-card card-elevated p-6">
          <div className="mb-4 flex items-center gap-2 text-label-md text-on-surface-variant">
            ...
            <span>Update expense details</span>
          </div>
