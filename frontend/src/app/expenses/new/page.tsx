...
/* ──────────────────────────────────────────────────────────────────────────── *
 * Clinical Precision — Create Expense Page
 *
 * Layout follows the same pattern as the Create Company page:
      ...
      <div className="w-full space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div className="prescription-border-l pl-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-headline-lg text-foreground">Record New Expense</h1>
                <p className="mt-1 text-body-md text-on-surface-variant">
                  Add a new operational expense for your pharmacy.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="rounded-xl border border-border bg-card card-elevated p-6">
          <div className="mb-4 flex items-center gap-2 text-label-md text-on-surface-variant">
            ...
            <span>Fill in the expense details below</span>
          </div>
